...
namespace ZeroEngine::UI {
	...
	void DrawButtonImage(const std::shared_ptr<ZeroEngine::Image>& imageNormal, const std::shared_ptr<ZeroEngine::Image>& imageHovered, const std::shared_ptr<ZeroEngine::Image>& imagePressed,
	...
	void DrawButtonImage(const std::shared_ptr<ZeroEngine::Image>& image,
		ImU32 tintNormal, ImU32 tintHovered, ImU32 tintPressed,
		ImVec2 rectMin, ImVec2 rectMax)
	{
